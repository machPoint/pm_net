    ...
    <section
      ...
      <header className="relative">
        <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
          ...
          <div className="absolute inset-0 -z-20 bg-[url('/hero-blur.jpg')] bg-cover bg-center grayscale blur-2xl opacity-60 scale-105" />
        ...
        <div
          ref={heroRef}
          className="relative !bg-[url(https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/1f9af503-df65-43cd-b334-accfd585572a/visual-edit-uploads/1757573267203-xfsal8y140e.jpg)] !bg-cover !bg-center">
          ...
          <div className="absolute inset-0 -z-10 overflow-hidden">
            <video
              ...
              muted
              playsInline
              poster="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/1f9af503-df65-43cd-b334-accfd585572a/visual-edit-uploads/1757562284571-7u0f54uxysy.jpg">
          ...
          <div className="container mx-auto max-w-5xl text-center">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-semibold tracking-tight leading-tight">
              Take Control of Complexity. Engineer Systems.
            </h1>
            ...
            <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
              <div className="overflow-hidden rounded-xl bg-secondary/60 ring-1 ring-border">
                <div className="aspect-[16/9] w-full">
                  <div
                    className="h-full w-full bg-center bg-cover !bg-[url(https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/1f9af503-df65-43cd-b334-accfd585572a/visual-edit-uploads/1758156811159-3dqi3xwyrfd.png)] !bg-cover !bg-center"
                    role="img"
                    aria-label="App preview image"
                    style={{ backgroundImage: "url('https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/1f9af503-df65-43cd-b334-accfd585572a/visual-edit-uploads/1757566362306-j65heicpug.png')" }} />
              ...
              <div className="relative overflow-hidden rounded-md">
                <div className="aspect-[16/9] w-full rounded-md bg-card/60 ring-1 ring-border">
                  <video
                    ...
                    muted
                    playsInline
                    poster="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=80&w=1400&auto=format&fit=crop"
                    aria-label="Systems engineering dashboard abstract visualization video">
            ...
            <div className="rounded-md bg-card/60 ring-1 ring-border p-4">
              ...
              <div className="aspect-[16/9] rounded ring-1 ring-border overflow-hidden">
                <video
                  ...
                  muted
                  playsInline
                  poster="https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/1f9af503-df65-43cd-b334-accfd585572a/visual-edit-uploads/1757566114880-6tkh1m9sofm.png"
                  aria-label="Code-like preview video">

                  <source src="/code-preview.mp4" type="video/mp4" />
                </video>
              </div>
            </div>
            <div className="rounded-md bg-card/60 ring-1 ring-border p-4">
              <div className="mb-3 text-sm font-medium">Smart Chatbot</div>
              <div className="aspect-[16/9] rounded bg-secondary/60 ring-1 ring-border flex items-center justify-center text-muted-foreground text-xs">Chat UI preview</div>
            </div>
            <div className="rounded-md bg-card/60 ring-1 ring-border p-4">
      ...
      <section className="container mx-auto max-w-6xl py-10 sm:py-12 md:py-14">
        <div className="rounded-lg bg-secondary/60 ring-1 ring-border p-6 sm:p-8">
          ...
          <h3 className="mt-2 text-2xl sm:text-3xl font-semibold">Start with something simple and scale up</h3>
          <div className="mt-6 grid grid-cols-1 gap-6">
            <div className="flex flex-wrap items-center gap-2">
              {[
              { id: "workflows", label: "Don't replace your current tools." },
              ...
              <button
                ...
                className={[
                "px-4 py-2 rounded-md text-sm ring-1",
                kfTab === t.id ? "bg-card/60 ring-border text-foreground" : "bg-background ring-border text-muted-foreground hover:text-foreground"].
                join(" ")}>
              ...
              <div className="rounded-md bg-card/60 ring-1 ring-border p-4">
                <div className="aspect-[16/10] rounded ring-1 ring-border overflow-hidden">
                  <video
                    ...
                    poster={
                    kfTab === "workflows" ?
                    "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/1f9af503-df65-43cd-b334-accfd585572a/visual-edit-uploads/1757566401524-fevo3fbkunc.png" :
                    kfTab === "logic" ?
                    "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/1f9af503-df65-43cd-b334-accfd585572a/visual-edit-uploads/1757566114880-6tkh1m9sofm.png" :
                    "https://slelguoygbfzlpylpxfs.supabase.co/storage/v1/object/public/project-uploads/1f9af503-df65-43cd-b334-accfd585572a/visual-edit-uploads/1757566362306-j65heicpug.png"
                    }
                    aria-label={
                    kfTab === "workflows" ?
                    "Multistep workflows preview" :
                    kfTab === "logic" ?
